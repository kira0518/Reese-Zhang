...
void loop()
{
      int x_pos = analogRead(x_joystick);
      int y_pos = analogRead(y_joystick);
      int z = digitalRead(z_joystick);

      // TRY TO SEND CHARACTERS INSTEAD OF STRING
      ...
      if(z == '0'){
        ...
        pos = 'w'; // EXAMPLE, NOW THIS IS A CHARACTER
          delay(100);
      }
      else if(x_pos > 700){
